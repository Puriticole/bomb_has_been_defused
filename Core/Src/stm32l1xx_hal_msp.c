...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA1     ------> ADC_IN1
    */
    GPIO_InitStruct.Pin = POT_DROIT_Pin|POT_GAUCHE_Pin;
    ...
    /* ADC1 interrupt Init */
    HAL_NVIC_SetPriority(ADC1_IRQn, 0, 5);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA1     ------> ADC_IN1
    */
    HAL_GPIO_DeInit(GPIOA, POT_DROIT_Pin|POT_GAUCHE_Pin);
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM10_MspInit 0 */
    ...
    HAL_NVIC_SetPriority(TIM10_IRQn, 0, 2);
...
void HAL_TIM_PWM_MspInit(TIM_HandleTypeDef* htim_pwm)
{
  ...
  /* USER CODE END TIM9_MspInit 0 */
    ...
    /* TIM9 interrupt Init */
    HAL_NVIC_SetPriority(TIM9_IRQn, 0, 4);
  ...
  /* USER CODE END TIM11_MspInit 0 */
    ...
    HAL_NVIC_SetPriority(TIM11_IRQn, 0, 4);
